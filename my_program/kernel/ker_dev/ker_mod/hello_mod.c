/*
  ...
  *
  *        Version:  1.0
  *        Created:  01/23/2013 21:12:05 PM
  *       Revision:  none
  *       Compiler:  gcc
  *
...
MODULE_AUTHOR("Xu, Marco");
MODULE_DESCRIPTION("This is a example kernel module for char device");
    ...
    if(down_interruptible(&sem))
     ...
     switch(langtype)
     {
         ...
         case chinese:
             ...
             sprintf(outbuffer, "Äºã¡ %s.", inbuffer);
             break;
         case pinyin:
